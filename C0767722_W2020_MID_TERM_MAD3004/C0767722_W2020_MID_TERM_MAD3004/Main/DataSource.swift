...
class DataSource
{
    ...
    static let source = DataSource()
    public static var data : [Customer] {
    do
    {
        Data
    ...
    let customerIDs = [customer1.customerID,customer2.customerID] // [101,102,103,104,105]
    for customerID in custDictionary
    {
